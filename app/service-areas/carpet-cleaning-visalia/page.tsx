...
export const metadata: Metadata = {
  title: "Carpet Cleaning Visalia, CA | Eco-Friendly | (559) 721-4400",
  description:
    "Professional carpet, tile, and upholstery cleaning in Visalia, CA. 5.0 stars, biodegradable products, 80% less water, dries in ~4 hours. Licensed & insured. Call (559) 721-4400.",
};
...
const schema = {
  ...
  areaServed: { "@type": "City", name: "Visalia", sameAs: "https://en.wikipedia.org/wiki/Visalia,_California" },
    ...
    <>
      ...
      <section style={{ background: "linear-gradient(135deg, #1B2A4A 0%, #2a3f6f 50%, #1B2A4A 100%)", padding: "100px 24px 80px", textAlign: "center" }}>
        <div style={{ maxWidth: 800, margin: "0 auto" }}>
          <div className="section-tag" style={{ background: "rgba(204,0,0,0.2)", color: "#fff" }}>Visalia, CA</div>
          <h1 style={{ fontSize: "clamp(2rem, 5vw, 3.2rem)", fontWeight: 900, color: "#fff", lineHeight: 1.15, marginBottom: 20 }}>
            Carpet Cleaning in Visalia<br /><span style={{ color: "#CC0000" }}>Gateway to the Sequoias, Spotlessly Clean</span>
          </h1>
          <p style={{ color: "rgba(255,255,255,0.8)", fontSize: "1.1rem", lineHeight: 1.7, maxWidth: 600, margin: "0 auto 36px" }}>
            Visalia — the Gateway to the Sequoias — deserves carpet and tile cleaning as majestic as its surroundings. Spot On delivers eco-friendly, professional service.
          </p>
      ...
      <section style={{ padding: "72px 24px", background: "#fff" }}>
        <div style={{ maxWidth: 800, margin: "0 auto" }}>
          <h2 style={{ fontSize: "1.6rem", fontWeight: 800, color: "#1B2A4A", marginBottom: 16 }}>Professional Carpet Cleaning in Visalia</h2>
          <p style={{ color: "#555", lineHeight: 1.8, fontSize: "1.05rem", marginBottom: 20 }}>
            Visalia is the largest city in Tulare County and one of the most vibrant communities in the Central Valley. From historic downtown to growing neighborhoods near Mooney Boulevard, Visalia homes reflect the pride of the people who live in them. Spot On helps keep those homes looking their best.
          </p>
          <p style={{ color: "#555", lineHeight: 1.8, fontSize: "1.05rem", marginBottom: 20 }}>
            Our low-moisture cleaning method is perfect for the valley&apos;s warm climate — using 80% less water and drying in approximately 4 hours. Every product is biodegradable and completely safe for your family and pets.
          </p>
          <p style={{ color: "#555", lineHeight: 1.8, fontSize: "1.05rem" }}>
            We serve both residential and commercial properties throughout Visalia. With 28 five-star reviews, fair pricing at $50–$75 per room, and fully licensed and insured operations, Spot On is the professional choice for Visalia&apos;s cleaning needs.
          </p>
        </div>
      </section>
      ...
      <section style={{ background: "#F5F5F5", padding: "72px 24px" }}>
        <div style={{ maxWidth: 1100, margin: "0 auto" }}>
          <div style={{ textAlign: "center", marginBottom: 40 }}>
            <div className="section-tag">Services in Visalia</div>
      ...
      <section style={{ padding: "72px 24px", background: "#fff" }}>
        <div style={{ maxWidth: 800, margin: "0 auto" }}>
          <div className="section-tag">Why Visalia Chooses Spot On</div>
      ...
      <section style={{ background: "linear-gradient(135deg, #CC0000, #AA0000)", padding: "72px 24px", textAlign: "center" }}>
        <div style={{ maxWidth: 700, margin: "0 auto" }}>
          <h2 style={{ color: "#fff", fontSize: "clamp(1.6rem, 4vw, 2.4rem)", fontWeight: 900, marginBottom: 16 }}>Ready for a Spot On Clean in Visalia?</h2>
