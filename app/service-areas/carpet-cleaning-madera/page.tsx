...
export const metadata: Metadata = {
  title: "Carpet Cleaning Madera, CA | Eco-Friendly | (559) 721-4400",
  description:
    "Professional carpet, tile, and upholstery cleaning in Madera, CA. 5.0 stars, biodegradable products, 80% less water, dries in ~4 hours. Licensed & insured. Call (559) 721-4400.",
};
...
const schema = {
  ...
  areaServed: { "@type": "City", name: "Madera", sameAs: "https://en.wikipedia.org/wiki/Madera,_California" },
    ...
    <>
      ...
      <section style={{ background: "linear-gradient(135deg, #1B2A4A 0%, #2a3f6f 50%, #1B2A4A 100%)", padding: "100px 24px 80px", textAlign: "center" }}>
        <div style={{ maxWidth: 800, margin: "0 auto" }}>
          <div className="section-tag" style={{ background: "rgba(204,0,0,0.2)", color: "#fff" }}>Madera, CA</div>
          <h1 style={{ fontSize: "clamp(2rem, 5vw, 3.2rem)", fontWeight: 900, color: "#fff", lineHeight: 1.15, marginBottom: 20 }}>
            Carpet Cleaning in Madera<br /><span style={{ color: "#CC0000" }}>Quality Service, Close to Home</span>
          </h1>
          <p style={{ color: "rgba(255,255,255,0.8)", fontSize: "1.1rem", lineHeight: 1.7, maxWidth: 600, margin: "0 auto 36px" }}>
            Madera families get the same 5-star, eco-friendly cleaning that the Central Valley trusts. Spot On makes the short drive so you don&apos;t have to compromise on quality.
          </p>
      ...
      <section style={{ padding: "72px 24px", background: "#fff" }}>
        <div style={{ maxWidth: 800, margin: "0 auto" }}>
          <h2 style={{ fontSize: "1.6rem", fontWeight: 800, color: "#1B2A4A", marginBottom: 16 }}>Trusted Cleaning for Madera Homes</h2>
          <p style={{ color: "#555", lineHeight: 1.8, fontSize: "1.05rem", marginBottom: 20 }}>
            Madera sits just north of Fresno, and its growing communities deserve professional-grade carpet and tile cleaning without the big-city price tag. Whether you&apos;re in a newer subdivision or an established neighborhood near downtown Madera, Spot On brings the same thoroughness and care to every home.
          </p>
          <p style={{ color: "#555", lineHeight: 1.8, fontSize: "1.05rem", marginBottom: 20 }}>
            Our low-moisture cleaning method is ideal for the Central Valley climate — using 80% less water than traditional steam cleaning and drying in about 4 hours. Every product is 100% biodegradable and completely safe for children, pets, and the environment.
          </p>
          <p style={{ color: "#555", lineHeight: 1.8, fontSize: "1.05rem" }}>
            We make the quick drive from Fresno regularly to serve Madera families. Same pricing, same 5-star quality, same eco-friendly commitment. Garo treats every Madera home like it&apos;s in his own neighborhood — because to him, it is.
          </p>
        </div>
      </section>
      ...
      <section style={{ background: "#F5F5F5", padding: "72px 24px" }}>
        <div style={{ maxWidth: 1100, margin: "0 auto" }}>
          <div style={{ textAlign: "center", marginBottom: 40 }}>
            <div className="section-tag">Services in Madera</div>
      ...
      <section style={{ padding: "72px 24px", background: "#fff" }}>
        <div style={{ maxWidth: 800, margin: "0 auto" }}>
          <div className="section-tag">Why Madera Chooses Spot On</div>
      ...
      <section style={{ background: "linear-gradient(135deg, #CC0000, #AA0000)", padding: "72px 24px", textAlign: "center" }}>
        <div style={{ maxWidth: 700, margin: "0 auto" }}>
          <h2 style={{ color: "#fff", fontSize: "clamp(1.6rem, 4vw, 2.4rem)", fontWeight: 900, marginBottom: 16 }}>Ready for a Spot On Clean in Madera?</h2>
