...
export const metadata: Metadata = {
  title: "Carpet Cleaning Clovis, CA | Eco-Friendly | (559) 721-4400",
  description:
    "Professional carpet, tile, and upholstery cleaning in Clovis, CA. 5.0 stars, biodegradable products, 80% less water, dries in ~4 hours. Licensed & insured. Call (559) 721-4400.",
};
...
const schema = {
  ...
  areaServed: { "@type": "City", name: "Clovis", sameAs: "https://en.wikipedia.org/wiki/Clovis,_California" },
    ...
    <>
      ...
      <section style={{ background: "linear-gradient(135deg, #1B2A4A 0%, #2a3f6f 50%, #1B2A4A 100%)", padding: "100px 24px 80px", textAlign: "center" }}>
        <div style={{ maxWidth: 800, margin: "0 auto" }}>
          <div className="section-tag" style={{ background: "rgba(204,0,0,0.2)", color: "#fff" }}>Clovis, CA</div>
          <h1 style={{ fontSize: "clamp(2rem, 5vw, 3.2rem)", fontWeight: 900, color: "#fff", lineHeight: 1.15, marginBottom: 20 }}>
            Carpet Cleaning in Clovis<br /><span style={{ color: "#CC0000" }}>Eco-Friendly & Fast-Drying</span>
          </h1>
          <p style={{ color: "rgba(255,255,255,0.8)", fontSize: "1.1rem", lineHeight: 1.7, maxWidth: 600, margin: "0 auto 36px" }}>
            Clovis families deserve the same 5-star cleaning that Fresno trusts. Spot On brings professional, eco-safe service right to your door.
          </p>
      ...
      <section style={{ padding: "72px 24px", background: "#fff" }}>
        <div style={{ maxWidth: 800, margin: "0 auto" }}>
          <h2 style={{ fontSize: "1.6rem", fontWeight: 800, color: "#1B2A4A", marginBottom: 16 }}>
            Professional Carpet & Tile Cleaning for Clovis Homes
          </h2>
          <p style={{ color: "#555", lineHeight: 1.8, fontSize: "1.05rem", marginBottom: 20 }}>
            Clovis — Gateway to the Sierras and one of the fastest-growing cities in the Central Valley. With newer homes in Loma Vista and Harlan Ranch to established neighborhoods around Old Town, Clovis residents take pride in their homes. Spot On matches that standard with professional carpet and tile cleaning that&apos;s eco-friendly and thorough.
          </p>
          <p style={{ color: "#555", lineHeight: 1.8, fontSize: "1.05rem", marginBottom: 20 }}>
            Our low-moisture method uses 80% less water than traditional steam cleaning and dries in about 4 hours — perfect for Clovis families who don&apos;t want to wait overnight to use their rooms. Every product is 100% biodegradable, safe for kids, pets, and the environment.
          </p>
          <p style={{ color: "#555", lineHeight: 1.8, fontSize: "1.05rem" }}>
            We&apos;re just next door in Fresno, so Clovis homes get priority scheduling and fast response times. Same 5-star service, same fair pricing.
          </p>
        </div>
      </section>
      ...
      <section style={{ background: "#F5F5F5", padding: "72px 24px" }}>
        <div style={{ maxWidth: 1100, margin: "0 auto" }}>
          <div style={{ textAlign: "center", marginBottom: 40 }}>
            <div className="section-tag">Services in Clovis</div>
      ...
      <section style={{ padding: "72px 24px", background: "#fff" }}>
        <div style={{ maxWidth: 800, margin: "0 auto" }}>
          <div className="section-tag">Why Clovis Chooses Spot On</div>
      ...
      <section style={{ background: "linear-gradient(135deg, #CC0000, #AA0000)", padding: "72px 24px", textAlign: "center" }}>
        <div style={{ maxWidth: 700, margin: "0 auto" }}>
          <h2 style={{ color: "#fff", fontSize: "clamp(1.6rem, 4vw, 2.4rem)", fontWeight: 900, marginBottom: 16 }}>Ready for a Spot On Clean in Clovis?</h2>
