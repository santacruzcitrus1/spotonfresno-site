...
export const metadata: Metadata = {
  title: "Carpet Cleaning Fowler, CA | Eco-Friendly | (559) 721-4400",
  description:
    "Professional carpet, tile, and upholstery cleaning in Fowler, CA. 5.0 stars, biodegradable products, 80% less water, dries in ~4 hours. Licensed & insured. Call (559) 721-4400.",
};
...
const schema = {
  ...
  areaServed: { "@type": "City", name: "Fowler", sameAs: "https://en.wikipedia.org/wiki/Fowler,_California" },
...
export default function FowlerPage() {
  return (
    <>
      ...
      <section style={{ background: "linear-gradient(135deg, #1B2A4A 0%, #2a3f6f 50%, #1B2A4A 100%)", padding: "100px 24px 80px", textAlign: "center" }}>
        <div style={{ maxWidth: 800, margin: "0 auto" }}>
          <div className="section-tag" style={{ background: "rgba(204,0,0,0.2)", color: "#fff" }}>Fowler, CA</div>
          <h1 style={{ fontSize: "clamp(2rem, 5vw, 3.2rem)", fontWeight: 900, color: "#fff", lineHeight: 1.15, marginBottom: 20 }}>
            Carpet Cleaning in Fowler<br /><span style={{ color: "#CC0000" }}>Your Local Carpet Cleaning Pro</span>
          </h1>
          <p style={{ color: "rgba(255,255,255,0.8)", fontSize: "1.1rem", lineHeight: 1.7, maxWidth: 600, margin: "0 auto 36px" }}>
            Fowler families get honest, eco-friendly carpet and tile cleaning from Spot On — the Central Valley&apos;s trusted local cleaner.
          </p>
      ...
      <section style={{ padding: "72px 24px", background: "#fff" }}>
        <div style={{ maxWidth: 800, margin: "0 auto" }}>
          <h2 style={{ fontSize: "1.6rem", fontWeight: 800, color: "#1B2A4A", marginBottom: 16 }}>Trusted Cleaning in Fowler</h2>
          <p style={{ color: "#555", lineHeight: 1.8, fontSize: "1.05rem", marginBottom: 20 }}>
            Fowler is a charming small city south of Fresno with a proud agricultural heritage and a strong sense of community. Homes here range from classic farmhouses to newer family residences, and all of them benefit from professional carpet and tile cleaning done right.
          </p>
          <p style={{ color: "#555", lineHeight: 1.8, fontSize: "1.05rem", marginBottom: 20 }}>
            Our low-moisture method uses 80% less water than traditional steam, and your carpets dry in about 4 hours. We use 100% biodegradable, eco-safe products — no harsh chemicals, no toxic residue, no risk to your family or pets.
          </p>
          <p style={{ color: "#555", lineHeight: 1.8, fontSize: "1.05rem" }}>
            Spot On serves Fowler with the same professionalism and fair pricing we bring to every city. $50–$75 per room, licensed and insured, with a 5.0 Yelp rating backed by 28 reviews.
          </p>
        </div>
      </section>
      ...
      <section style={{ background: "#F5F5F5", padding: "72px 24px" }}>
        <div style={{ maxWidth: 1100, margin: "0 auto" }}>
          <div style={{ textAlign: "center", marginBottom: 40 }}>
            <div className="section-tag">Services in Fowler</div>
      ...
      <section style={{ padding: "72px 24px", background: "#fff" }}>
        <div style={{ maxWidth: 800, margin: "0 auto" }}>
          <div className="section-tag">Why Fowler Chooses Spot On</div>
      ...
      <section style={{ background: "linear-gradient(135deg, #CC0000, #AA0000)", padding: "72px 24px", textAlign: "center" }}>
        <div style={{ maxWidth: 700, margin: "0 auto" }}>
          <h2 style={{ color: "#fff", fontSize: "clamp(1.6rem, 4vw, 2.4rem)", fontWeight: 900, marginBottom: 16 }}>Ready for a Spot On Clean in Fowler?</h2>
